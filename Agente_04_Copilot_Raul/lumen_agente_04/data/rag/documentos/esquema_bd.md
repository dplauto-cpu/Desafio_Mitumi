...
### `presupuestos`
`id`, `estado_presupuesto`, `total`, `fecha`, `nota_ubicacion`, `precio_ubicacion`, `catering`, `nota_catering`, `precio_catering`, `audiovisuales`, `nota_audiovisuales`, `precio_audiovisuales`, `otros`, `nota_otros`, `precio_otros`
