...
# --- Email ---
# leo el servidor de correo saliente (SMTP)
SMTP_HOST = os.environ.get("SMTP_HOST", "")
# leo el puerto del servidor de correo; por defecto el 587
SMTP_PORT = int(os.environ.get("SMTP_PORT", "587"))
# leo el usuario con el que me conecto al correo
SMTP_USER = os.environ.get("SMTP_USER", "")
# leo la contraseña de aplicación del correo
SMTP_PASSWORD = os.environ.get("SMTP_PASSWORD", "")
# leo desde qué dirección envío; si no me la dan, uso el propio usuario
EMAIL_FROM = os.environ.get("EMAIL_FROM", SMTP_USER)
# preparo la lista de personas que reciben el email
DESTINATARIOS = [
    # limpio los espacios de cada dirección
    addr.strip()
    # recorro cada trozo separando por comas la variable de entorno
    for addr in os.environ.get("DESTINATARIOS", "").split(",")
    # me quedo solo con los trozos que no están vacíos
    if addr.strip()
]
