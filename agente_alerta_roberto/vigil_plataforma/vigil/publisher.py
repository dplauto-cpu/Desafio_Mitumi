...
# convierto el texto del plazo a formato ISO para que la plataforma lo use fácil
def _plazo_iso(plazo_texto: str | None) -> str | None:
...
def _alerta_a_dict(alerta: Alerta, archivo_ics: str | None) -> dict:
    ...
    return {
        ...
        "plazo_iso": _plazo_iso(conv.plazo_presentacion),
        # el importe sin IVA
