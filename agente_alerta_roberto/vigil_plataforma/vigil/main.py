...
# traigo los módulos de deduplicado y de publicación hacia la plataforma
from vigil import dedupe, publisher
    ...
    with dedupe.get_connection(SQLITE_PATH) as conn:
        ...
        for cruda in crudas:
            ...
            if veredicto.relevante:
                # calculo el semáforo de urgencia con el plazo y el estado
